...
async function verifyOffers(offers) {
  ...
  try {
    ...
    // Fork path adjustment: scan.mjs lives at agents/scanner/scan.mjs;
    // liveness-browser.mjs lives at the repo root next to liveness-core.mjs
    // and check-liveness.mjs, so walk up two levels from this file.
